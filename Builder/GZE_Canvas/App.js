...
Module['FS_createPath']('/Rc', 'Fonts', true, true);
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 41208, "filename": "/Rc/Fonts/Proggy.ttf"}, {"start": 41208, "audio": 0, "end": 76864, "filename": "/Rc/Fonts/ProggyTiny.ttf"}], "remote_package_size": 76864, "package_uuid": "be444e40-5f5f-447e-ab57-ba0d9f167df9"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5324288,
    DYNAMIC_BASE = 5324288,
    DYNAMICTOP_PTR = 81152;
...
var ASM_CONSTS = [function() { if (!!window.WebGLRenderingContext) { var names = (['webgl2', 'webgl', 'experimental-webgl', 'moz-webgl']); var gl = false; var canvas = document.createElement("canvas"); for(var i in names) { try { gl = canvas.getContext(names[i]); if (gl && typeof gl.getParameter == "function") { return i; } } catch(e) {} } return -1; } return -2; },
 ...
 function() { Module['canvas'].style.backgroundColor = 'black'; }];
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=81200;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {

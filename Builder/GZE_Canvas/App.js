...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = '_out/Web_Emsc_Debug/App.data';
...
Module['FS_createPath']('/', 'Rc', true, true);
Module['FS_createPath']('/Rc', 'Fonts', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile__out/Web_Emsc_Debug/App.data');

    };
    Module['addRunDependency']('datafile__out/Web_Emsc_Debug/App.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 41208, "filename": "/Rc/Fonts/Proggy.ttf"}, {"start": 41208, "audio": 0, "end": 76864, "filename": "/Rc/Fonts/ProggyTiny.ttf"}], "remote_package_size": 76864, "package_uuid": "f72abe93-8c17-4b3a-b713-291d0295743e"});
...
var ASM_CONSTS = [function() { if (!!window.WebGLRenderingContext) { var names = (['webgl2', 'webgl', 'experimental-webgl', 'moz-webgl']); var gl = false; var canvas = document.createElement("gze_canvas"); for(var i in names) { try { gl = canvas.getContext(names[i]); if (gl && typeof gl.getParameter == "function") { return i; } } catch(e) {} } return -1; } return -2; },
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=82752;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
...
var real__GzfEmscMalloc = asm["_GzfEmscMalloc"]; asm["_GzfEmscMalloc"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__GzfEmscMalloc.apply(null, arguments);
};
...
Module["asm"] = asm;
var _GzfEmscMalloc = Module["_GzfEmscMalloc"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_GzfEmscMalloc"].apply(null, arguments) };
